...
import {AdminMovieDeleteSection} from "./components/AdminMovieDeleteSection";
import { AdminMovieEditSection } from "./components/AdminMovieEditSection";
const AdminPage = () => {
  ...
  return (
    <>
      ...
      <AdminMovieDeleteSection />
      <AdminMovieEditSection />
