      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">movie plex</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to movie plex,</p>
          <p>
            At movie plex, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at movie plex and immerse yourself in the captivating world
