...
export const CollectionCard = ({
  ...
  console.log("FIRST TYPE OF RATING IS: ", typeof rating);

// Initialize ourRating with 0 initially
let ourRating = 0;

if (typeof rating === "number") {
    // If it's already a number, keep it as it is
    ourRating = rating;
} else {
    ...
    if (!isNaN(convertedRating)) {
        // If the conversion is successful, update ourRating
        ourRating = convertedRating;
    } else {
        // If it's not a valid number, keep ourRating as 0
        ourRating = 0;
    }
}

console.log("RATING IS: ", ourRating);
